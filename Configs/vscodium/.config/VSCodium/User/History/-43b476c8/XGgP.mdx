...
```conf
$blur_layer = dms:(notification-modal|workspace-overview|color-picker|clipboard|spotlight|settings|process-list-modal)
layerrule = blur, $blur_layer
$blur_shell = dms:(bar|control-center|notification-center|dash|system-update|process-list-popout|battery|popout|app-launcher)
