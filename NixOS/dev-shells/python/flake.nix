# I highkey stole it all from here: https://github.com/Sly-Harvey/NixOS/blob/master/dev-shells/python/flake.nix
# Prolly should try to do my own but like idk how to do ts rn
